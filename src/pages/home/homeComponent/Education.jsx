...
const Education = () => {
    return (
        <div>
           <section id="education" className="bg-black text-white py-12 px-6 md:px-20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          {/* BSc */}
          <div className="bg-[#1e1e1e] p-6 rounded-xl shadow-lg border-l-4 border-blue-500">
          ...
          {/* HSC */}
          <div className="bg-[#1e1e1e] p-6 rounded-xl shadow-lg border-l-4 border-green-500">
          ...
          {/* SSC */}
          <div className="bg-[#1e1e1e] p-6 rounded-xl shadow-lg border-l-4 border-yellow-500">
            <h3 className="text-2xl font-semibold">Secondary School Certificate (SSC)</h3>
