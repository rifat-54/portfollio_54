...
const About = () => {
    return (
        <div className='px-2 md:px-3 lg:px-5 py-20 grid grid-cols-1 md:grid-cols-2'>
            
            {/* photo */}
            <div>
                <img className='rounded-md' src="https://i.ibb.co.com/4Z6QSj3y/images-16.jpg" alt="" />
            </div>
            {/* text */}
            <div>
                <h2 className='text-2xl font-semibold mb-4'>Hello,I'm <span className='text-blue-400'>Rifat</span></h2>
                <h4 className='text-xl mb-3 text-green-500 font-semibold'>Passionate Web Developer | Student | Tech Enthusiast</h4>
